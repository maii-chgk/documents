...
2.8. На обращения на официальную почту Группы, которые не являются
...
3.7. Статус кооптированных участников не отличается от статуса
...
5.3. Участник Группы, не согласный с принятым решением, вправе написать
