...
При проведении [мультиязычных турниров](#^^multilang_tournament) в контексте данных правил все языковые версии вопроса считаются одним вопросом с общими критериями оценки правильности ответов.
...
При проведении [мультиязычных турниров](#^^multilang_tournament) в редакционную группу включаются также переводчики отдельных языковых версий пакета.
...
### §§§ Апелляция на ошибку в переводе вопроса

Апелляции на ошибку в переводе вопроса принимаются только на [мультиязычных турнирах](#^^multilang_tournament) и только если это предусмотрено регламентом турнира.
...
## §§answer_evaluation Оценка правильности ответа

§§§right_answer Ответ считается правильным, если выполняется хотя бы одно из перечисленных условий:
...
d. он содержит ответ, который подлежит зачёту по какому-то из подпунктов п. <^^right_answer> (a–c, e–g), а также дополнительную верную информацию, которая не может быть истолкована как альтернативный неверный ответ;
e. он указывает на ту же реалию (или реалии, если их несколько), что и авторский ответ или ответ, соответствующий критериям зачёта, и при этом является достаточно точным согласно п. <^^wrong_answer>.
...
Ответы, уже зачтённые ИЖ и АЖ, для целей пункта <^^answer_evaluation> следует считать эквивалентными ответам, соответствующим критериям зачёта.

§§§wrong_answer Ответ считается неправильным, если:
...
f. он содержит более одного ответа, причём как минимум один из них нельзя засчитать в качестве верного ответа согласно п. <^^right_answer>.
g. вследствие неразборчивости он имеет несколько вариантов прочтения и как минимум один из них нельзя засчитать в качестве верного ответа согласно п. <^^right_answer>.
h. жюри считает его недостаточно точным в соответствии с п. <^^accuracy>.
i. он отклонён по техническим причинам в соответствии с пунктом <^^tech_reject>.

§§§right_answer_tech Техническая группа засчитывает в качестве правильного ответ команды, если считает его правильным в соответствии с подпунктами a–d пункта <^^right_answer>.

Техническая группа включает ответ команды в список спорных при наличии любых сомнений по поводу правильности или неправильности ответа, в частности, если считает его правильным в соответствии с подпунктами e–g пункта <^^right_answer>.

§§§right_answer_game_jury Игровое жюри засчитывает в качестве правильного ответ команды, в случае если считает его правильным в соответствии с подпунктами a–g пункта <^^right_answer>. Игровому жюри рекомендуется пользоваться подпунктом g лишь в том случае, если в состав игрового жюри входят представители редакционной группы.

§§§right_answer_appeal_jury Апелляционное жюри засчитывает в качестве правильного ответ команды, в случае если считает его правильным в соответствии с подпунктами a–f пункта <^^right_answer>.

§§§accuracy Чтобы определить, является ли отличающийся от авторского ответ достаточно точным, игровое и апелляционное жюри учитывают указания относительно требуемой точности ответа в следующем порядке уменьшения значимости:
...
## §§multilang_tournament Мультиязычный турнир
