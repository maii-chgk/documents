...
По окончании розыгрыша последнего вопроса либо в перерывах между блоками вопросов организационная группа предоставляет командам возможность ознакомиться с текстом вопросов, информацией о зачтённых им ответах, а также формирует список спорных ответов.

Список спорных ответов состоит из:

- ответов, внесённых туда технической группой по собственной инициативе;
- ответов, внесённых туда организационной группой по просьбе команд.

Организационная группа обязана включить в список спорных ответов по запросу команды данный ею ответ (включая засчитанный), за исключением случаев технического незачёта (см. п. [4.2](#42)).

По итогам рассмотрения спорных ответов организационная группа сообщает командам решения игрового жюри.
...
**1.7.1.** <a name="171"></a> Ответ считается правильным:
a. если он совпадает с авторским ответом или критериями зачёта;
b. если он отличается от авторского ответа или критериев зачёта лишь грамматическими формами, порядком слов, синтаксисом и пунктуацией, при этом смысл ответа не меняется и продолжает соответствовать всем условиям вопроса;
c. если он отличается от авторского ответа или критериев зачёта наличием орфографических ошибок, сокращений или неразборчиво написанных символов, при этом ответ не может быть трактован двояко и продолжает соответствовать всем условиям вопроса.

**1.7.1.** <a name="171"></a> Ответ считается правильным, если:

a. он совпадает с авторским ответом или критериями зачёта;
...
g. жюри считает его отличие от авторского ответа или любого из ответов, признанных правильным согласно предыдущим подпунктам, незначительным в контексте вопроса.
...
- подпунктами a–f пункта 1.7.1, а также подпунктом g в том случае, если в игровое жюри входит как минимум один член редакторской группы.

**1.7.3.** <a name="173"></a>Апелляционное жюри засчитывает в качестве правильного ответ команды, в случае если считает его правильным в соответствии с:
