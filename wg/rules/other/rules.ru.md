...
- при оформлении переводных языковых версий должно быть явно указано, что это переводная версия, с какого и на какой язык она переведена, и список переводчиков.
