...
### 1.2.1.[]{#1.2.1} Организационная группа
...
### 1.2.2.[]{#1.2.2} Редакционная группа
...
### 1.2.3.[]{#1.2.3} Техническая группа
...
### 1.2.5.[]{#1.2.5} Апелляционное жюри
...
1.4.4.[]{#1.4.4} Розыгрыш вопроса состоит из следующих этапов, проходящих последовательно:
...
1.7.1.[]{#1.7.1} Техническая группа засчитывает в качестве правильного ответ команды:
...
1.7.2.[]{#1.7.2} Игровое жюри засчитывает в качестве правильного ответ команды:
...
1.7.3.[]{#1.7.3} Апелляционное жюри засчитывает в качестве правильного ответ команды:
...
## 4.2.[]{#4.2} Технический незачёт ответа
...
4.2.2.[]{#4.2.2} Члены организационной группы в обязательном порядке применяют технический незачёт ответа в следующих случаях:
