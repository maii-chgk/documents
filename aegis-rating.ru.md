...
subtitle: Текущая версия положения действует с 12 апреля 2024 года, полная история изменений — в приложении.
---
...
<a name="a15"></a> **А.1.5.** <Удалён по результатам голосования ДАТА>.
...
## Приложение Б. Требования к организаторам рейтингуемых турниров <a name="b"></a>

<a name="b1"></a> **Б.1.** Организаторы рейтингуемых турниров обязаны соблюдать следующие временные рамки при проведении:
...
<a name="b2"></a> **Б.2.** Организаторы синхронных турниров также обязаны соблюдать следующие временные рамки при проведении:

**X+72 часа (3 суток):** крайний срок внесения на [Турнирный сайт](#turnir-site) информации о составах, результатах и спорных ответах; 

**X+144 часа (6 суток):** крайний срок публикации вердиктов ИЖ по спорным ответам.

**X+216 часов (9 суток):** крайний срок подачи апелляций;

**X+384 часа (16 суток):** крайний срок публикации вердиктов АЖ[**](aster2);
...
**5.** По [результатам](https://www.maii.li/docs/2024-03-19-protokol-obshego-sobraniya-maii-ot-10.03.2024#3) [ОС](#os) МАИИ 10—11.03.2024 дополнен пункт 2.2.4.6.1, заменён пункт 2.3.4, появились пункты 2.2.4.10 и 2.3.4.1. Изменения вступили в силу 12.04.2024.
