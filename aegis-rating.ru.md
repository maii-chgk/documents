...
<a name="a4_1_1"></a> **A.4.1.1.** Команда начинает со стартового рейтинга (см. [A.4.11](#4_11)). Рейтинг команды меняется на величину бонусов, полученных ею за участие в турнирах (см. [А.4.8](#a4_8)). 
...
<a name="a4_1_3"></a> **A.4.1.3.** Поскольку на турнирах команда может выступать в разных составах, для учёта в рейтинге каждая команда определяет набор игроков, называемый базовым составом (см. [A.1](#a1), [A.4.3](#a_4_3), [A.4.4](#a4_4)). Далее в этом разделе игроки, не входящие в базовый состав, называются _легионерами_; команды, не преемственные ни к одному базовому составу, называются _сборными_.

<a name="a4_1_4"></a> **A.4.1.4.** Для учёта влияния легионеров и оценки силы сборных команд вычисляется т.н. рейтинг игроков (см. [A.4.9](#a4_9)).

<a name="a4_1_5"></a> **A.4.1.5.** Рейтинг игроков используется для расчёта технического рейтинга команды, который определяется её составом на турнире (см. [A.4.10](#a4_10)).

<a name="a4_1_6"></a> **A.4.1.6.** Рейтинг игроков и рейтинг команд связаны коэффициентом $Q$, который пересчитывается каждый релиз (см. [A.4.10.2](#a4_10_2)) на основе рейтинга команд из топ-100 и технических рейтингов их базовых составов.
