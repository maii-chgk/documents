...
<a name="a4_1_6"></a> **A.4.1.6.** Для учёта в рейтинге каждая команда определяет набор игроков, называемый базовым составом (см. [A.1](#a1), [A.4.3](#a4_3)). Бонусы (полученные преемственным составом) учитываются только для команд, имеющих базовый состав.
