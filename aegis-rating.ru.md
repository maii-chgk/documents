...
<a name="a4_1_5"></a> **A.4.1.5.** Поскольку на турнирах команда может выступать в разных составах, для определения того, можно ли данный состав идентифицировать с командой или он отличается слишком сильно, вводятся правила преемственности (см. [A.4.3](#a4_3), [A.4.4](#a4_4)).
