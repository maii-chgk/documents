...
<a name="22461"></a> **2.2.4.6.1.** До начала турнира: список редакторов, состав игрового и апелляционного жюри. В случае мультиязычного турнира кроме того должны быть указаны язык или языки основной (оригинальной) версии пакета, языки, на которых пакет доступен для отыгрыша.
...
<a name="22410"></a> **2.2.4.10.** В случае проведения мультиязычного турнира регламент должен разрешать апелляции на ошибку в переводе вопроса.
...
<a name="234"></a> **2.3.4.** В случае мультиязычного турнира — если не менее 5 % вопросов турнира были сняты в результате апелляций на ошибку в переводе вопроса.

<a name="2341"></a> **2.3.4.1.** В особых случаях [ТГ](#tg) может принять решение о раздельном рейтинговании отыгрышей различных языковых версий пакета без учёта апелляций на ошибку в переводе вопроса. Иными словами, если существенное количество вопросов было снято по этой причине, ТГ может разделить результаты турнира, при этом такие вопросы будут учтены в результатах каждой отдельной языковой версии.

<a name="235"></a> **2.3.5.** По иным причинам, которые [ТГ](#tg) посчитает грубым нарушением Правил.
